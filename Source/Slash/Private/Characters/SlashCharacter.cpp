...
void ASlashCharacter::Look(const FInputActionValue& Value)
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::White, FString::Printf(TEXT("txt:%f"), LookAxisValue.Y));
...
void ASlashCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if(UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(RotationAction, ETriggerEvent::Triggered, this, &ASlashCharacter::Look);
...
void ASlashCharacter::SetWeaponEnableCollision(ECollisionEnabled::Type CollisionEnabled)
{
